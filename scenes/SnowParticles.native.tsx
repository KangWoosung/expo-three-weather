...
function makeLayerConfigs(): SnowLayerConfig[] {
  ...
  return [
    { hsl: [1.00, 0.20, 0.5], size: 20, rotation: [rnd() * 6, rnd() * 6, rnd() * 6] },
    { hsl: [0.95, 0.10, 0.5], size: 15, rotation: [rnd() * 6, rnd() * 6, rnd() * 6] },
    { hsl: [0.90, 0.05, 0.5], size: 10, rotation: [rnd() * 6, rnd() * 6, rnd() * 6] },
    { hsl: [0.85, 0.00, 0.5], size: 8, rotation: [rnd() * 6, rnd() * 6, rnd() * 6] },
    { hsl: [0.80, 0.00, 0.5], size: 5, rotation: [rnd() * 6, rnd() * 6, rnd() * 6] },
  ]
}
...
const SNOW_FRAGMENT_SHADER = `
  ...
  void main() {
    ...
    vec3 snowColor = mix(vec3(1.0), sprite.rgb, 0.45) * uColor;
